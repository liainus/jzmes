...
from sqlalchemy import (Column, Integer, String,
                        DateTime, ForeignKey,Table, Boolean)
...
class User(Base):
    ...
    #用户名
    UserName = Column(String(64), primary_key=False, autoincrement=False, nullable=True)
    # 密码
    Password = Column(String(128), nullable=False)
    #登录账号
    LoginName = Column(String(64), primary_key=False, autoincrement=False, nullable=True)
    #登录状态
    Status = Column(String(32), primary_key=False, autoincrement=False, nullable=True)
    #创建用户
    Creater = Column(String(64), primary_key=False, autoincrement=False, nullable=True)
    #创建时间
    ...
    #所属组织
    OrganizationCode = Column(String(100), primary_key=False, autoincrement=False, nullable=True)
    # 查询用户所属角色
