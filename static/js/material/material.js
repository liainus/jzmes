...
$(function () {
    ...
    var urlPrefix = '/material/material/';
    ...
    $(tableId).datagrid({
        ...
        onSelect: function (index, row) {
            ...
            if(row){
                ...
                $('#MaterialPropertyTable').datagrid('load',{materialId : row.id})
            }
        }
    });
    ...
    MaterialToolbar = {
        ...
        create: function () {
            ...
            $('#materialClassComboboxForMaterial').combobox('reload');
            $('#materialClassComboboxForMaterial').combobox('textbox').bind('focus',function(){
                $('#materialClassComboboxForMaterial').combobox('showPanel');
            });
        },
        update : function () {
            ...
            if (rows.length > 1) {
                ...
                if (row) {
                    ...
                    $('#materialClassComboboxForMaterial').combobox('reload');
                    $('#materialClassComboboxForMaterial').combobox('setValue',row['materialClass'].id);
                }
        ...
        save : function () {
            if ($(formId).form('validate')) {
                ...
                var entity = {
                    ...
                    'materialClass.id' : $('#materialClassComboboxForMaterial').combobox('getValue')
                };
                $.ajax({
                    url : url,
                    method : 'POST',
