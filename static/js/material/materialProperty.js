...
$(function () {
    ...
    var urlPrefix = '/material/materialProperty/';
    var idPrefix = 'MaterialProperty';
    var titleText = "物料属性";
    ...
    MaterialPropertyToolbar = {
        ...
        create: function () {
            ...
            if (row) {
                ...
                $(formId).form('clear');
                $(formId + ' input[name="material"]').val(row.id);
                this.saveUrl = urlPrefix + 'create';
        ...
        update: function () {
            ...
            if (rows.length > 1) {
                ...
                if (row) {
                    ...
                    $('input[name="text"]').focus();
                    $(formId + ' input[name="material"]').val(row.material.id);
                    this.saveUrl = urlPrefix + 'update';
        ...
        save: function () {
            if ($(formId).form('validate')) {
                var entity = {
                    ...
                    'material.id': $(formId + ' input[name="material"]').val()
                };
                console.log(entity);
                $.ajax({
                    url: this.saveUrl,
