...
$(function () {
    ...
    var urlPrefix = 'material/materialClassProperty/';
    var idPrefix = 'MaterialClassProperty';
    var titleText = "物料类别属性";
        ...
        save : function () {
            if ($(formId).form('validate')) {
                ...
                var entity = {
                    ...
                    'materialClass.id' : $('#materialClassCombobox').combobox('getValue')
