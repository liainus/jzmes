...
$(function () {
    ...
    // var urlPrefix = 'data/datagrid_Unit.json';
    var urlPrefix = '/allUnits/';
    var idPrefix = 'UnitClass';
    ...
    return {
     ...
     $('input[name="iUnitName"]').change(function () {
         var sUnitName = $('input[name="iUnitName"]').val();
        if(Bee.StringUtils.isNotEmpty(sUnitName)){
            //alert('角色名称不能为空！');
            //return false;
        }else{
            alert('角色名称不能为空！:');
        ...
        // $('input[name="iUnitCode"]').change(function () {
        //  var sUnitCode = $('input[name="iUnitCode"]').val();
        // if(Bee.StringUtils.isNotEmpty(sUnitCode)){
        //     //alert('角色名称不能为空！');
        //     //return false;
        // }else{
        //     alert('角色名称不能为空！:');
        ...
        // }})
        //
        // $('input[name="iUnitSeq"]').change(function () {
        //  var sUnitSeq = $('input[name="iUnitSeq"]').val();
        // if(Bee.StringUtils.isInteger(sUnitSeq)){
        //     //alert('角色名称不能为空！');
        //     //return false;
        // }else{
        //     alert('序号要为整数！:');
    ...
    UnitClassToolbar = {
        ...
        create: function () {
            ...
            $('input[name="iID"]').val();
            $('input[name="iUnitCode"]').val();
            $('input[name="iUnitName"]').val();
            $('input[name="iDesc"]').val();// $('input[name="iUnitSeq"]').onChange()
            // $(formId).form('clear');
            message = '新增' + titleText;
            // $('#UnitClassCombobox').combobox('textbox').bind('focus', function () {
            //     $('#UnitClassCombobox').combobox('showPanel');
            // });
        },
        update: function () {
            ...
            if (rows.length > 1) {
                ...
                if (row) {
                    ...
                    $('input[name="iUnitCode"]').val(row.UnitCode);
                    $('input[name="iUnitName"]').val(row.UnitName);
                    ...
                    $('input[name="iUnitName"]').focus();
                    // $('#UnitClassCombobox').combobox('setValue',row['UnitClass'].id);
        ...
        save: function () {
            ...
            if (strID.length >= 1){
                ...
                var entity = {
                    ...
                    UnitCode:$('input[name="iUnitCode"]').val(),
                    UnitName:$('input[name="iUnitName"]').val(),
                ...
                $.ajax({
                    ...
                    success: function (data,response,status) {
                        ...
                        if(obj1[0].status == "OK"){
                            ...
                            $(tableId).datagrid('reload',{ url: "/allUnits/Find?_t=" + new Date().getTime() });
