...
$(function () {
    ...
    // var urlPrefix = 'data/datagrid_ProductUnit.json';
    var urlPrefix = '/allProductUnits/';
    var idPrefix = 'ProductUnitClass';
    ...
    return {
     ...
     $('input[name="iProductUnitName"]').change(function () {
         var sProductUnitName = $('input[name="iProductUnitName"]').val();
        if(Bee.StringUtils.isNotEmpty(sProductUnitName)){
            //alert('角色名称不能为空！');
            //return false;
        }else{
            alert('角色名称不能为空！:');
        ...
        // $('input[name="iProductUnitCode"]').change(function () {
        //  var sProductUnitCode = $('input[name="iProductUnitCode"]').val();
        // if(Bee.StringUtils.isNotEmpty(sProductUnitCode)){
        //     //alert('角色名称不能为空！');
        //     //return false;
        // }else{
        //     alert('角色名称不能为空！:');
        ...
        // }})
        //
        // $('input[name="iProductUnitSeq"]').change(function () {
        //  var sProductUnitSeq = $('input[name="iProductUnitSeq"]').val();
        // if(Bee.StringUtils.isInteger(sProductUnitSeq)){
        //     //alert('角色名称不能为空！');
        //     //return false;
        // }else{
        //     alert('序号要为整数！:');
    ...
    ProductUnitClassToolbar = {
        ...
        create: function () {
            ...
            $('input[name="iID"]').val("");
            $('input[name="iPDUnitCode"]').val("");
            $('input[name="iPDUnitName"]').val("");
            ...
            // $('#ProductUnitClassCombobox').combobox('textbox').bind('focus', function () {
            //     $('#ProductUnitClassCombobox').combobox('showPanel');
            // });
        },
        update: function () {
            ...
            if (rows.length > 1) {
                ...
                if (row) {
                    ...
                    $('input[name="iPDUnitCode"]').val(row.PDUnitCode);
                    $('input[name="iPDUnitName"]').val(row.PDUnitName);
                    ...
                    $('input[name="iProductUnitName"]').focus();
                    // $('#ProductUnitClassCombobox').combobox('setValue',row['ProductUnitClass'].id);
        ...
        save: function () {
            ...
            var msg = ""
            var urlAddr = ""
            var stmp = $('input[name="iPDUnitCode"]').val();
            if(Bee.StringUtils.isEmpty(stmp)) {
               alert('Warning：产品段编号不能为空！');
               return false;
            }
            stmp = $('input[name="iPDUnitName"]').val();
            if(Bee.StringUtils.isEmpty(stmp)) {
            ...
            if (strID.length >= 1){
                ...
                var entity = {
                    ...
                    PDUnitCode:$('input[name="iPDUnitCode"]').val(),
                    PDUnitName:$('input[name="iPDUnitName"]').val(),
