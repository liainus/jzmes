...
$(function () {
    ...
    var urlPrefix = '/segment/equipmentSegmentSpecification/';
    var idPrefix = 'EquipmentSegmentSpecification';
    var titleText = "设备段技术规范";
    ...
    EquipmentSegmentSpecificationToolbar = {
        url: "",
        message : "",
        search: function () {
        ...
        update : function () {
            ...
            if (rows.length > 1) {
                ...
                if (row) {
                    ...
                    $('#equipmentClassComboboxForEquipmentSegmentSpecification').combobox('reload');
                    $('#equipmentClassComboboxForEquipmentSegmentSpecification').combobox('setValue',row['equipmentClass'].id);
                    //$('#equipmentClassComboboxForProcessSegment').combobox('reload');
                    $('#equipmentComboboxForEquipmentSegmentSpecification').combobox('setValue',row['equipment'].id);
        ...
        save : function () {
            if ($(formId).form('validate')) {
                ...
                var entity = {
                    ...
                    'equipmentClass.id' : $('#equipmentClassComboboxForEquipmentSegmentSpecification').combobox('getValue'),
                    'equipment.id' : $('#equipmentComboboxForEquipmentSegmentSpecification').combobox('getValue'),
