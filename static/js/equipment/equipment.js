...
$(function () {
    ...
    var urlPrefix = '/equipment/equipment/';
    var idPrefix = 'Equipment';
    var titleText = "设备";
    ...
    EquipmentToolbar = {
        ...
        update : function () {
            var rows = $(tableId).treegrid('getSelections');
            if (rows.length > 1) {
                ...
                if (row) {
                    ...
                    $('input[name="text"]').focus();
                    $('input[name="parent"]').val(row['parent'].id);
        ...
        save : function () {
            if ($(formId).form('validate')) {
                ...
                var entity = {
                    ...
                    'parent.id' : $('input[name="parent"]').val(),
