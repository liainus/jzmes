...
$(function () {
    ...
    var urlPrefix = '/equipment/equipmentProperty/';
    var idPrefix = 'EquipmentProperty';
    var titleText = "设备属性";
    ...
    EquipmentPropertyToolbar = {
        ...
        create: function () {
            ...
            $('#equipmentCombobox').combobox('textbox').bind('focus',function(){
                $('#equipmentCombobox').combobox('showPanel');
            });
        },
        update : function () {
            ...
            if (rows.length > 1) {
                ...
                if (row) {
                    ...
                    $('#equipmentCombobox').combobox('setValue',row['equipment'].id);
                }
        ...
        save : function () {
            if ($(formId).form('validate')) {
                ...
                var entity = {
                    ...
                    'equipment.id' : $('#equipmentCombobox').combobox('getValue')
                };
                $.ajax({
                    url : url,
                    method : 'POST',
