...
@app.route('/CollectParams/config/find', methods=['POST', 'GET'])
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            if len(json_str) > 10:
                ...
                if total > 0:
                    qDatas = db_session.query(CollectParams).all()[inipage:endpage]
                    # ORM模型转换json格式
...
# @app.route('/CollectParams/config/create', methods=['POST', 'GET'])
